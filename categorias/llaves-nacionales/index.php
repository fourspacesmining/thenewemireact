...
<main>
<!--<div class ="header1">
    <img src="/paginallaves/fondo.png" alt="fondo" style="width:100%;">
...
<h2>
    <form name="filtro" id="filtro" action="index.php" method="post">
        ...
        <select name="subject" id="subject" onchange="this.form.submit()">
            ...
            <option value="llave" <?php if ($categoria == 'llave') echo 'selected="selected"'; ?>>Llaves</option>
            <option value="torreta" <?php if ($categoria == 'torreta') echo 'selected="selected"'; ?>>Torretas</option>
            <option value="otro" <?php if ($categoria == 'otro') echo 'selected="selected"'; ?>>Otros</option>
        </select>
    </form>
</h2> 
<br>
<div class = listado>
    ...
    if ($categoria != 'todo') {
        $sql = "SELECT SKU, nombre, precio, enlace, categoria FROM llaves_nacionales WHERE categoria = '$categoria'";
    } else {
        $sql = "SELECT SKU, nombre, precio, enlace, categoria FROM llaves_nacionales";
    }
