...
<form name="filtro" id="filtro" action="index.php" method="post">
        ...
        <select name="subject" id="subject" onchange="this.form.submit()">
            ...
            <option value="ojos" <?php if ($categoria == 'ojos') echo 'selected="selected"'; ?>>Lavado de ojos/cara</option>
            <option value="esta" <?php if ($categoria == 'esta') echo 'selected="selected"'; ?>>Estaciones de seguridad</option>
            <option value="grif" <?php if ($categoria == 'grif') echo 'selected="selected"'; ?>>Lavaojos montados en grifo</option>
        </select>
    </form>
</h2> 
<br>
<div class = listado>
    ...
    if ($categoria != 'todo') {
        $sql = "SELECT SKU, nombre, precio, enlace, categoria FROM regaderas_importadas WHERE categoria = '$categoria'";
    } else {
        $sql = "SELECT SKU, nombre, precio, enlace, categoria FROM regaderas_importadas";
    }
