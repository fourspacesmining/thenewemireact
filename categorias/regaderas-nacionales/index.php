...
<form name="filtro" id="filtro" action="index.php" method="post">
        ...
        <select name="subject" id="subject" onchange="this.form.submit()">
            ...
            <option value="regaGalv" <?php if ($categoria == 'regaGalv') echo 'selected="selected"'; ?>>Regaderas de Acero Galvanizado</option>
            <option value="LavaGalv" <?php if ($categoria == 'lavaGalv') echo 'selected="selected"'; ?>>Lavaojos de Acero Galvanizado</option>
            <option value="regaInox" <?php if ($categoria == 'regaInox') echo 'selected="selected"'; ?>>Regaderas de Acero Inoxidable</option>
            <option value="lavaInox" <?php if ($categoria == 'lavaInox') echo 'selected="selected"'; ?>>Lavaojos de Acero Inoxidable</option>
            <option value="porta" <?php if ($categoria == 'porta') echo 'selected="selected"'; ?>>Lavaojos portátiles</option>
        </select>
    </form>
</h2> 
<br>
<div class = listado>
    ...
    if ($categoria != 'todo') {
        $sql = "SELECT SKU, nombre, precio, enlace, categoria FROM regaderas_nacionales WHERE categoria = '$categoria'";
    } else {
        $sql = "SELECT SKU, nombre, precio, enlace, categoria FROM regaderas_nacionales";
    }
